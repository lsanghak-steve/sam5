  ...
  cities: [
    {
      ...
      x: 48,
      y: 42,
      adjacentCityIds: ["ye", "xia", "shou", "luoyang", "chenliu", "qiao", "runan", "henei"],
    },
    {
      id: "ye",
      name: "업",
      ...
      x: 42,
      y: 18,
      adjacentCityIds: ["xu", "bei", "luoyang", "nanpi", "pingyuan", "chenliu", "jinyang", "shangdang", "henei", "puyang"],
    },
    {
      id: "bei",
      name: "북평",
      ...
      x: 70,
      y: 13,
      adjacentCityIds: ["ye", "xia", "nanpi", "pingyuan", "langye", "daijun"],
    },
    {
      id: "xia",
      name: "하비",
      ...
      x: 67,
      y: 45,
      adjacentCityIds: ["xu", "bei", "jianye", "langye", "donghai", "guangling"],
    },
    {
      id: "shou",
      name: "수춘",
      ...
      x: 43,
      y: 62,
      adjacentCityIds: ["xu", "jing", "jianye", "xiangyang", "qiao", "runan", "xinye", "jiangxia", "guangling", "lujiang"],
    },
    {
      id: "jing",
      name: "강릉",
      ...
      x: 28,
      y: 74,
      adjacentCityIds: ["shou", "chengdu", "jianye", "xiangyang", "wuling", "ba", "jiangxia", "yidu"],
    },
    {
      id: "chengdu",
      name: "성도",
      ...
      x: 10,
      y: 58,
      adjacentCityIds: ["jing", "hanzhong", "ba", "jiangzhou", "yongchang", "yongan"],
    },
    {
      id: "jianye",
      name: "건업",
      ...
      x: 75,
      y: 72,
      adjacentCityIds: ["xia", "shou", "jing", "kuaiji", "yuzhang", "wujun", "guangling", "lujiang"],
    },
    {
      id: "luoyang",
      name: "낙양",
      ...
      x: 34,
      y: 39,
      adjacentCityIds: ["changan", "ye", "xu", "xiangyang", "hongnong", "xinye", "chenliu", "shangdang", "henei"],
    },
    {
      id: "changan",
      name: "장안",
      ...
      x: 21,
      y: 38,
      adjacentCityIds: ["tianshui", "hanzhong", "luoyang", "hongnong", "anding", "shangdang"],
    },
    {
      id: "tianshui",
      name: "천수",
    ...
    },
    {
      ...
      x: 15,
      y: 53,
      adjacentCityIds: ["changan", "tianshui", "chengdu", "xiangyang", "hongnong", "ba", "yongan"],
    },
    {
      id: "xiangyang",
      name: "양양",
      ...
      x: 32,
      y: 59,
      adjacentCityIds: ["luoyang", "shou", "jing", "hanzhong", "wuling", "xinye", "jiangxia", "yongan"],
    },
    {
      id: "wuling",
      name: "무릉",
      ...
      x: 29,
      y: 80,
      adjacentCityIds: ["jing", "xiangyang", "lingling", "changsha", "ba", "yidu"],
    },
    {
      id: "lingling",
      name: "영릉",
    ...
    },
    {
      ...
      x: 61,
      y: 90,
      adjacentCityIds: ["lingling", "kuaiji", "cangwu", "nanhai", "luling", "hepu"],
    },
    {
      id: "nanpi",
      name: "남피",
      ...
      adjacentCityIds: ["ye", "pingyuan", "bei", "jinyang"],
    },
    {
      id: "pingyuan",
      name: "평원",
      ...
      adjacentCityIds: ["nanpi", "ye", "bei", "puyang"],
    },
    {
      id: "chenliu",
      name: "진류",
      ...
      adjacentCityIds: ["xu", "ye", "luoyang", "langye", "qiao", "puyang"],
    },
    {
      id: "qiao",
      name: "초",
    ...
    },
    {
      ...
      adjacentCityIds: ["xia", "bei", "chenliu", "puyang", "donghai"],
    },
    {
      id: "hongnong",
      name: "홍농",
    ...
    },
    {
      ...
      adjacentCityIds: ["shou", "xiangyang", "jing", "yuzhang", "changsha", "lujiang"],
    },
    {
      id: "changsha",
      name: "장사",
    ...
    },
    {
      ...
      adjacentCityIds: ["jianye", "jiangxia", "changsha", "luling", "lujiang"],
    },
    {
      id: "luling",
      name: "여릉",
    ...
    },
    {
      ...
      adjacentCityIds: ["lingling", "guiyang", "jiaozhi", "nanhai", "hepu"],
    },
    {
      id: "nanhai",
      name: "남해",
      ...
      y: 98,
      image: "assets/cities/jiaozhi.png",
      adjacentCityIds: ["jiaozhi", "cangwu", "hepu"],
    },
    {
      id: "ba",
      name: "파군",
      ...
      adjacentCityIds: ["chengdu", "hanzhong", "jing", "wuling", "yidu", "jiangzhou", "yongan"],
    },
    {
      id: "jinyang",
      name: "진양",
      ...
      y: 7,
      image: "assets/cities/ye.png",
      adjacentCityIds: ["ye", "nanpi", "shangdang", "daijun"],
    },
    {
      id: "daijun",
      name: "대군",
    ...
    },
    {
      ...
      y: 27,
      image: "assets/cities/luoyang.png",
      adjacentCityIds: ["jinyang", "ye", "changan", "luoyang", "henei"],
    },
    {
      id: "henei",
      name: "하내",
      ...
      y: 32,
      image: "assets/cities/luoyang.png",
      adjacentCityIds: ["shangdang", "ye", "xu", "luoyang"],
    },
    {
      id: "puyang",
      name: "복양",
      ...
      y: 28,
      image: "assets/cities/xu.png",
      adjacentCityIds: ["ye", "pingyuan", "chenliu", "langye"],
    },
    {
      id: "donghai",
      name: "동해",
      ...
      y: 48,
      image: "assets/cities/xia.png",
      adjacentCityIds: ["langye", "xia", "guangling"],
    },
    {
      id: "guangling",
      name: "광릉",
      ...
      y: 59,
      image: "assets/cities/jianye.png",
      adjacentCityIds: ["donghai", "xia", "shou", "jianye"],
    },
    {
      id: "lujiang",
      name: "여강",
      ...
      y: 64,
      image: "assets/cities/jianye.png",
      adjacentCityIds: ["shou", "jianye", "jiangxia", "yuzhang"],
    },
    {
      id: "yidu",
      name: "이도",
      ...
      y: 75,
      image: "assets/cities/wuling.png",
      adjacentCityIds: ["jing", "wuling", "ba", "jiangzhou"],
    },
    {
      id: "jiangzhou",
      name: "강주",
      ...
      y: 78,
      image: "assets/cities/chengdu.png",
      adjacentCityIds: ["chengdu", "ba", "yidu", "yongchang"],
    },
    {
      id: "yongchang",
      name: "영창",
      ...
      y: 88,
      image: "assets/cities/chengdu.png",
      adjacentCityIds: ["chengdu", "jiangzhou"],
    },
    {
      id: "hepu",
      name: "합포",
      ...
      y: 96,
      image: "assets/cities/jiaozhi.png",
      adjacentCityIds: ["jiaozhi", "cangwu", "nanhai"],
    },
    {
      id: "yongan",
      name: "영안",
      ...
      x: 20,
      y: 63,
      image: "assets/cities/hanzhong.png",
      adjacentCityIds: ["chengdu", "hanzhong", "xiangyang", "ba"],
    },
  ],
  officers: [
